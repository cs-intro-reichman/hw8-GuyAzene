public class TestHandler {
    ...
    public boolean networkAddFolloweeTests(int testNumber) {
        switch (testNumber) {
            case 1:
                return networkAddFolloweeTest1();
            case 2:
                return networkAddFolloweeTest2();
            case 3:
                return networkAddFolloweeTest3();
            case 4:
                return networkAddFolloweeTest4();
            case 5:
                return networkAddFolloweeTest5();
            case 6:
                return networkAddFolloweeTest6();
            case 7:
                return networkAddFolloweeTest7();
            case 8:
                return networkAddFolloweeTest8();
            case 9:
                return networkAddFolloweeTest9();
            default:
                return false;
        }
    }
    ...
    public boolean networkRecommendWhoToFollowTests(int testNumber) {
        switch (testNumber) {
            case 1:
                return recommendWhoToFollowTest1();
            case 2:
                return recommendWhoToFollowTest2();
            case 3:
                return recommendWhoToFollowTest3();
            default:
                return false;
        }
    }
    ...
    public boolean networkMostPopularUserTests(int testNumber) {
        switch (testNumber) {
            case 1:
                return mostPopularUserTest1();
            case 2:
                return mostPopularUserTest2();
            case 3:
                return mostPopularUserTest3();
            case 4:
                return mostPopularUserTest4();
            case 5:
                return mostPopularUserTest5();
            case 6:
                return mostPopularUserTest6();
            case 7:
                return mostPopularUserTest7();
            case 8:
                return mostPopularUserTest8();
            case 9:
                return mostPopularUserTest9();
            case 10:
                return mostPopularUserTest10();
            default:
                return false;
        }
    }
    ...
    public boolean networkToStringTests(int testNumber) {
        switch (testNumber) {
            case 1:
                return toStringTest1();
            case 2:
                return toStringTest2();
            case 3:
                return toStringTest3();
            case 4:
                return toStringTest4();
            default:
                return false;
        }
    }
